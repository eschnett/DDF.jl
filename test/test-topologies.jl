...
@testset "Topology D=$D" for D in 0:Dmax
    ...
    if D > 1
        ...
        topo2 = Topology(topo1.simplices[D-1])
    ...
    if D == 2
        ...
        topo2 = Topology(SVector{D+1}.([(1, 2, 4),
                                        (1, 4, 6),
                                        (4, 3, 6),
                                        (6, 3, 5),
                                        (3, 1, 5),
    ...
    if D == 2
        ...
        topo2 = Topology(SVector{D+1}.([(1, 2, 3),
                                        (1, 3, 4),
                                        (1, 4, 2),
                                        (2, 3, 4)]))
        @test ndims(topo2) == D
    ...
    if D == 1
        # a line
        p0, p2, p1 = 1:3
        topo3 = Topology(SVector{D+1}.([(p0, p1), (p2, p1)]))
        @test ndims(topo3) == D
    ...
    if D == 2
        ...
        p00, p02, p20, p22,
        p11 = 1:5
        topo4 = Topology(SVector{D+1}.([(p00, p02, p11),
                                        (p02, p22, p11),
                                        (p22, p20, p11),
                                        (p20, p00, p11)]))
        @test ndims(topo4) == D
    ...
    if D == 3
        ...
        p111 = 1:15
        topo5 = Topology(SVector{D+1}.([(p000, p020, p110, p111),
                                        (p020, p220, p110, p111),
                                        (p220, p200, p110, p111),
                                        (p200, p000, p110, p111),
                                        (p002, p022, p112, p111),
    ...
    if D > 1
        ...
        topo7 = Topology(topo6.simplices[D-1])
